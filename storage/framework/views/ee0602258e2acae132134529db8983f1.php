            ...
            <div class="card-header">
                ...
                <div>
                    <span class="badge" style="background-color: var(--light); color: var(--dark);">
                        <i class="fas fa-users"></i> จำนวนนักศึกษาทั้งหมด: <span id="student-count">0</span>
                    </span>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="data-table">
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                ...
                                <td><?php echo e(formatThaiDate($row['column0'])); ?></td> <!-- ใช้ฟังก์ชันแปลงวันที่ -->
                                <td><span class="badge badge-id"><?php echo e($row['column2']); ?></span></td>
                                <td><?php echo e($row['column3']); ?> <?php echo e($row['column4']); ?></td>
    ...
    <script>
        ...
        function loadInitialData() {
            ...
            initialData = Array.from(rows).map((row, index) => {
                ...
                return {
                    index: index + 1,
                    rawDate: cells[1].textContent.trim(), // วันที่ที่แปลงแล้วจาก Blade
                    studentId: cells[2].querySelector(".badge-id").textContent.trim(),
                    name: cells[3].textContent.trim(),
                    status: cells[4].querySelector(".badge").textContent.trim().replace(/^\s*✔\s*/, "")
                };
            });
            filteredData = [...initialData];
            document.getElementById("student-count").textContent = initialData.length;
            console.log("Initial Data:", initialData);
        }

        // ไม่ต้องมี formatCustomDate() อีกต่อไป เพราะแปลงใน Blade แล้ว
        ...
        document.getElementById("current-date").textContent = `${now.getDate()} ${thaiMonths[now.getMonth()]} ${thaiYear}`;
        ...
        function populateTable(data, page = 1) {
            ...
            paginatedData.forEach((student) => {
                ...
                row.innerHTML = `
                    ...
                    <td>${student.rawDate}</td> <!-- ใช้วันที่ที่แปลงแล้ว -->
        ...
        function updatePagination(totalItems, currentPage) {
            ...
            firstLi.innerHTML = '<a href="#"><i class="fas fa-angle-double-left"></i></a>';
            firstLi.addEventListener('click', () => {
                if (currentPage > 1) renderPage(1, filteredData);
            });
            pagination.appendChild(firstLi);

            // ปุ่ม "ก่อนหน้า"
            const prevLi = document.createElement('li');
            prevLi.innerHTML = '<a href="#"><i class="fas fa-angle-left"></i></a>';
            ...
            if (startPage > 1) {
                ...
                if (currentPage === 1) firstPageA.classList.add('active');
                firstPageA.addEventListener('click', () => renderPage(1, filteredData));
            ...
            for (let i = startPage; i <= endPage; i++) {
                ...
                a.addEventListener('click', () => renderPage(i, filteredData));
                li.appendChild(a);
            ...
            if (endPage < totalPages) {
                ...
                if (currentPage === totalPages) lastPageA.classList.add('active');
                lastPageA.addEventListener('click', () => renderPage(totalPages, filteredData));
            ...
            nextLi.innerHTML = '<a href="#"><i class="fas fa-angle-right"></i></a>';
            ...
            lastLi.innerHTML = '<a href="#"><i class="fas fa-angle-double-right"></i></a>';
            lastLi.addEventListener('click', () => {
                if (currentPage < totalPages) renderPage(totalPages, filteredData);
            });
            pagination.appendChild(lastLi);
        }

        // Render หน้าตามข้อมูลและหน้า
        ...
        function performSearch() {
            ...
            if (searchTerm) {
                filteredData = initialData.filter(student =>
                    ...
                    student.rawDate.toLowerCase().includes(searchTerm) // ใช้วันที่ที่แปลงแล้ว
                );
            ...
            document.getElementById("student-count").textContent = filteredData.length;
...
</html><?php /**PATH D:\xampp\htdocs\Project7\resources\views/welcome.blade.php ENDPATH**/ ?>